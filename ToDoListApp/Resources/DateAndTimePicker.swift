...
@objc open class DateAndTimePicker: NSObject {
    
    private static let sharedInstance = DateAndTimePicker()
    ...
    */
    ...
    private class func controller(title: String? = nil,
        ...
        if let cc = UIWindow.currentController {
            if DateAndTimePicker.sharedInstance.isPresented == false {
                DateAndTimePicker.sharedInstance.isPresented = true
                ...
                vc.onWillDismiss = {
                    DateAndTimePicker.sharedInstance.isPresented = false
                }
